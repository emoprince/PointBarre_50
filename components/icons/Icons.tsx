...
export const MilkIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m5 7 1.11 1.55a2 2 0 0 0 1.78 1.05h4.22a2 2 0 0 0 1.78-1.05L15 7" />
    <path d="M5 7V5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2" />
    <path d="M5 10v10a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V10" />
    <path d="M17 10h.01" />
    <path d="M17 14h.01" />
    <path d="M17 18h.01" />
  </svg>
...
export const SyrupIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2v10" />
        <path d="M12 16v2" />
        <path d="M8 7h8" />
